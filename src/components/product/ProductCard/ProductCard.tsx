 ...
 * @returns
 */
export const ProductCard = (props: { product: Product; className:any }) => {
  ...
  return (
    <div
      className={clsx(
        `card w-48 h-80 glass flex flex-col items-center justify-around overflow-hidden py-4 px-0 !shadow-md ${props.className}`
      )}
      dir="rtl"
    >
      {/* image */}
