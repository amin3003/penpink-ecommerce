        ...
        >
          <div className="flex flex-col justify-center gap-3">
            ...
            <p className="text-[12px] md:text-xs text-justify">
              در وارد کردن شماره تلفن دقت نمایید,زیرا کلیه موارد خرید و ارسال
              کالا از طریق پیامک به اطلاع شما خواهد رسید.
            </p>
            ...
            />
            {errors.name && (
              <span className="text-red-500">{errors.postId}</span>
            )}
            <TextField
              name="address"
              type="text"
